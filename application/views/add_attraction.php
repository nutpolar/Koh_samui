            ...
            <div class="content_place" id="tabs">
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td><input type="text"class="inputs tBody" placeholder="Attraction Name" name="name" id="name" onchange="checkText('name');" required=""/></td>
                    </tr>

                    <tr>
                        <td align="right" class="tHead">Detail : </td>
                        <td>
                            <textarea name="detail" class="inputs tBody" placeholder="Detail" rows="10" cols="20" id="detail" onchange="checkText('detail');" required=""></textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="address" class="inputs tBody" placeholder="Address" rows="5" cols="20" id="address" onchange="checkText('address');" required=""></textarea>
                        </td>
                    </tr>
...
<!--                                            <input type="text"class="inputs" placeholder="Contact"/>-->
                            <textarea name="contact" class="inputs tBody" placeholder="Contact" rows="3" cols="20" id="contact" onchange="checkText('contact');" required=""></textarea>
                        </td>
                    </tr>

                    <tr>
                        <td align="right" class="tHead">Latitude : </td>
                        <td><input type="text" name="latitude" class="inputs tBody" placeholder="Latitude" OnKeyPress="return chkNumber(this)" required=""/></td>
                    </tr>

                    <tr>
                        <td align="right" class="tHead">Longitude : </td>
                        <td><input type="text" name="longitude" class="inputs tBody" placeholder="Longitude" OnKeyPress="return chkNumber(this)" required=""/></td>
                    </tr>


                    <tr>
                        <td align="right" class="tHead">Open Time/Close Time : </td>
                        <td><input type="text" name="open" class="inputs tBody" placeholder="Time" id="time" onchange="checkText('time');" /></td>
                    </tr>

                    <tr>
                        <td align="right" class="tHead">Service Charge : </td>
                        <td><input type="text" name="service" class="inputs tBody" placeholder="Service Charge" id="service" onchange="checkText('service');"/></td>
                    </tr>
