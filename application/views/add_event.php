                ...
                <div class="content_place" id="tabs">
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td><input type="text"class="inputs tBody" placeholder="Event Name" name="name" id="name" onchange="checkText('name');" required=""/></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="detail" class="inputs tBody" placeholder="Link" rows="10" cols="20" id="link" onchange="checkText('link');"></textarea>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="location" class="inputs tBody" placeholder="Detail" rows="5" cols="20" id="detail" onchange="checkText('detail');"></textarea>
                            </td>
                        </tr>
